...
function init() {
    ...
    progDraw.iR = gl.getUniformLocation(progDraw, "iR");
    progDraw.iG = gl.getUniformLocation(progDraw, "iG");
    progDraw.iB = gl.getUniformLocation(progDraw, "iB");
...
function render(deltaMS) {
    ...
    gl.uniform1f(progDraw.iR, color.r );
    gl.uniform1f(progDraw.iG, color.g );
    gl.uniform1f(progDraw.iB, color.b );
